...
/**
 * 此fragment将被填充到{@link ImageDetailActivity}里的ViewPager的children里 This fragment
 * will populate the children of the ViewPager from {@link ImageDetailActivity}.
 */
public class ImageDetailFragment extends Fragment {
	...
	public static ImageDetailFragment newInstance(int imageNum) {
		Log.d(TAG, "调用ImageDetailFragment newInstance(int imageNum)， iamgeNum = " + imageNum);
	...
	public void onCreate(Bundle savedInstanceState) {
		Log.d(TAG, "ImageDetailFragment--onCreate()被调用");
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		Log.d(TAG, "ImageDetailFragment--onCreateView()被调用");
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		Log.d(TAG, "ImageDetailFragment--onActivityCreated()被调用");
